...
#' The theory is same as [terra::extract], `TimeVectData` or `TimeRastData` will be extracted (weighted average) in the given polygons (`mask_area`).
#' The weight will be calculated with the area of polygons or raster-cells, that in the `mask_area`.
#' **NOTE**: this function can be used only for the **value, that makes sense in weighted average**.
#' @name extract_tsd
